...
export function blur({ relatedTarget } = {}) {
  return new window.FocusEvent('blur', { relatedTarget });
}
...
export function focus({ relatedTarget } = {}) {
  return new window.FocusEvent('focus', { relatedTarget });
}

export function focusin({ relatedTarget } = {}) {
  return new window.FocusEvent('focusin', { relatedTarget });
}

export function focusout({ relatedTarget } = {}) {
  return new window.FocusEvent('focusout', { relatedTarget });
}
